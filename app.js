...
const lessonmodel = require("./models/unit");
...
async function writeFiles(){
  const us = await lessonmodel.getModel().find({})
  const qi = await quizmodel.find({})
  const de = await degreemodel.find({})
  const o = [{ "_id" : "639081a8d0d9a9abddf868ab", "month" : "الشهر الاول", "grade" : "1st", 
  "educetionlevel" : "biology", "__v" : 0 },
  { "_id" : "6391f42ad0d9a9abddf86dad", "month" : "الشهر الثاني", "grade" : "1st",
   "educetionlevel" : "biology", "__v" : 0 },
  { "_id" : "6396f544d0d9a9abddf88681", "month" : "الشهر الثالث", "grade" : "1st",
   "educetionlevel" : "biology", "__v" : 0 },
  { "_id" : "6396fc3bd0d9a9abddf8871c", "month" : "الشهر الرابع", "grade" : "1st",
   "educetionlevel" : "biology", "__v" : 0 },
  { "_id" : "639f4087d0d9a9abddf8b649", "month" : "الشهر الخامس", "grade" : "1st",
   "educetionlevel" : "biology", "__v" : 0 },
  { "_id" : "63aeb2a8d0d9a9abddf9b6f7", "month" : "الشهر السادس", "grade" : "1st",
   "educetionlevel" : "biology", "__v" : 0 }]
  fs.writeFile("as.json" ,JSON.stringify(o, null, 4) ,(err)=>{
    if(err) throw err
  })
